...
from sds_client.models.multi_response_dataset import MultiResponseDataset  # noqa: E501

class TestMultiResponseDataset(unittest.TestCase):
    """MultiResponseDataset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultiResponseDataset:
        """Test MultiResponseDataset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultiResponseDataset`
        """
        model = MultiResponseDataset()  # noqa: E501
        if include_optional:
            return MultiResponseDataset(
                total = 56,
                search_after = 56,
                datasets = [
                    sds_client.models.dataset.Dataset(
                        collector_id = '', 
                        ...
                        beam_info = sds_client.models.beam_info.BeamInfo(
                            mode = '', 
                            state = '', 
                            present = '', 
                            len = 1.337, 
    ...
    def testMultiResponseDataset(self):
        """Test MultiResponseDataset"""
