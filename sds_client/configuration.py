...
class Configuration:
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://sds-retriever.cyolo.ess.eu/api" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("sds_client")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://sds-retriever.cyolo.ess.eu/api",
