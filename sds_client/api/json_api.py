...
class JsonApi:
    ...
    @validate_arguments
    def get_json_by_dataset_query_json_query_post(self, start : Optional[datetime] = None, end : Optional[datetime] = None, sds_event_cycle_id_start : Optional[StrictInt] = None, sds_event_cycle_id_end : Optional[StrictInt] = None, size : Optional[StrictInt] = None, include_pvs : Optional[conlist(StrictStr)] = None, collector_id_list : Optional[CollectorIdList] = None, **kwargs) -> object:  # noqa: E501
        """Get Json By Dataset Query  # noqa: E501

        Search for datasets in the index and returns a json with all hits. - **collector_id** (List[str], optional): list of collector IDs to   consider for the search - **start** (int, optional): UTC timestamp for interval start - **end** (int, optional): UTC timestamp for interval end - **sds_event_cycle_id_start** (int, optional): SDS event cycle ID for interval start - **sds_event_cycle_id_end** (int, optional): SDS event cycle ID for interval end - **size** (int, optional): Limit the number of results. If used alone, it will return the latest *size* datasets - **include_pvs** (List[str], optional): list of PVs to return  To search for a set of PVs, first one needs to search for collectors containing those PVs and then search by collector IDs.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_json_by_dataset_query_json_query_post(start, end, sds_event_cycle_id_start, sds_event_cycle_id_end, size, include_pvs, collector_id_list, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_json_by_dataset_query_json_query_post_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_json_by_dataset_query_json_query_post_with_http_info(start, end, sds_event_cycle_id_start, sds_event_cycle_id_end, size, include_pvs, collector_id_list, **kwargs)  # noqa: E501

    @validate_arguments
    def get_json_by_dataset_query_json_query_post_with_http_info(self, start : Optional[datetime] = None, end : Optional[datetime] = None, sds_event_cycle_id_start : Optional[StrictInt] = None, sds_event_cycle_id_end : Optional[StrictInt] = None, size : Optional[StrictInt] = None, include_pvs : Optional[conlist(StrictStr)] = None, collector_id_list : Optional[CollectorIdList] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get Json By Dataset Query  # noqa: E501
        ...
        >>> thread = api.get_json_by_dataset_query_json_query_post_with_http_info(start, end, sds_event_cycle_id_start, sds_event_cycle_id_end, size, include_pvs, collector_id_list, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_json_by_dataset_query_json_query_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
