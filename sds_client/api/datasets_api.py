...
class DatasetsApi:
    ...
    @validate_arguments
    def query_datasets_datasets_get(self, collector_id : Optional[conlist(StrictStr)] = None, start : Optional[datetime] = None, end : Optional[datetime] = None, sds_event_pulse_id_start : Optional[StrictInt] = None, sds_event_pulse_id_end : Optional[StrictInt] = None, sort : Optional[Any] = None, search_after : Optional[StrictInt] = None, **kwargs) -> MultiResponseDataset:  # noqa: E501
        """Query Datasets  # noqa: E501

        Search for datasets in the index. - **collector_id** (List[str], optional): list of collector IDs to   consider for the search - **start** (int, optional): UTC timestamp for interval start - **end** (int, optional): UTC timestamp for interval end - **sds_event_pulse_id_start** (int, optional): SDS event pulse ID for interval start - **sds_event_pulse_id_end** (int, optional): SDS event pulse ID for interval end - **sort** (SortOrder, optional): to sort results in ascending or descending order in time - **search_after** (int, optional): to scroll over a large number of hits  To search for a set of PVs, first one needs to search for collectors containing those PVs and then search by collector IDs.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.query_datasets_datasets_get(collector_id, start, end, sds_event_pulse_id_start, sds_event_pulse_id_end, sort, search_after, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the query_datasets_datasets_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.query_datasets_datasets_get_with_http_info(collector_id, start, end, sds_event_pulse_id_start, sds_event_pulse_id_end, sort, search_after, **kwargs)  # noqa: E501

    @validate_arguments
    def query_datasets_datasets_get_with_http_info(self, collector_id : Optional[conlist(StrictStr)] = None, start : Optional[datetime] = None, end : Optional[datetime] = None, sds_event_pulse_id_start : Optional[StrictInt] = None, sds_event_pulse_id_end : Optional[StrictInt] = None, sort : Optional[Any] = None, search_after : Optional[StrictInt] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Query Datasets  # noqa: E501
        ...
        >>> thread = api.query_datasets_datasets_get_with_http_info(collector_id, start, end, sds_event_pulse_id_start, sds_event_pulse_id_end, sort, search_after, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method query_datasets_datasets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
