...
[**get_nexus_by_dataset_query_nexus_query_get**](NexusApi.md#get_nexus_by_dataset_query_nexus_query_get) | **GET** /nexus/query | Get Nexus By Dataset Query
...
# **get_nexus_by_dataset_query_nexus_query_get**
> get_nexus_by_dataset_query_nexus_query_get(collector_id=collector_id, start=start, end=end, sds_event_pulse_id_start=sds_event_pulse_id_start, sds_event_pulse_id_end=sds_event_pulse_id_end, include_pvs=include_pvs)
...
with sds_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Nexus By Dataset Query
        api_instance.get_nexus_by_dataset_query_nexus_query_get(collector_id=collector_id, start=start, end=end, sds_event_pulse_id_start=sds_event_pulse_id_start, sds_event_pulse_id_end=sds_event_pulse_id_end, include_pvs=include_pvs)
    except Exception as e:
        print("Exception when calling NexusApi->get_nexus_by_dataset_query_nexus_query_get: %s\n" % e)
```
...
Get a NeXus file from the storage - **path** (str, required): file path
...
Get a set of NeXus files containing the requested datasets, one file per collector (zipped if needed). - **datasets** (List[Dataset], required): list of datasets to download - **include_pvs** (List[str], optional): list of PVs to return
